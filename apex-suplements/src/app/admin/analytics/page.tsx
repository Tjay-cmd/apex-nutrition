...
const RevenueChart = dynamic(() => import('@/components/admin/analytics/revenue-chart'), { ssr: false });
const OrderTrendsChart = dynamic(() => import('@/components/admin/analytics/order-trends-chart'), { ssr: false });
